...
export const RANKINGS = {
  overall: [
    { m: 'Gemini 3.1 Pro', p: 'google', s: 96, dims: [93, 96, 88, 90, 93, 92] },
    { m: 'GPT-5.2', p: 'openai', s: 95, dims: [94, 95, 86, 92, 95, 94] },
    { m: 'Claude Opus 5', p: 'anthropic', s: 95, dims: [96, 92, 87, 95, 94, 93] },
    { m: 'Grok 4.1', p: 'xai', s: 93, dims: [88, 91, 82, 88, 87, 88] },
    { m: 'Kimi K3', p: 'moonshot', s: 92, dims: [89, 90, 92, 91, 90, 91] },
    { m: 'DeepSeek V4', p: 'deepseek', s: 91, dims: [90, 93, 94, 89, 88, 89] },
    { m: 'Qwen3 Max', p: 'aliyun', s: 90, dims: [91, 89, 93, 85, 89, 88] },
    { m: 'GLM-5.2', p: 'zhipu', s: 89, dims: [88, 86, 91, 87, 86, 86] },
  ...
  code: [
    { m: 'Claude Opus 5', p: 'anthropic', s: 96 }, { m: 'GPT-5.2', p: 'openai', s: 94 },
    { m: 'Gemini 3.1 Pro', p: 'google', s: 93 }, { m: 'Qwen3 Coder Plus', p: 'aliyun', s: 92 },
    { m: 'DeepSeek V4', p: 'deepseek', s: 90 }, { m: 'Kimi K3', p: 'moonshot', s: 89 },
    { m: 'GLM-5.2', p: 'zhipu', s: 88 }, { m: 'MiniMax M2', p: 'minimax', s: 87 },
